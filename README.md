# embd [![Build Status](https://travis-ci.org/kidoman/embd.svg?branch=master)](https://travis-ci.org/kidoman/embd) [![GoDoc](http://godoc.org/github.com/jjcinaz/embd?status.png)](http://godoc.org/github.com/jjcinaz/embd)
...
Also, you might be interested in: [Why Golang?](https://github.com/jjcinaz/embd/wiki/Why-Go)
...
import (
	...
	_ "github.com/jjcinaz/embd/host/rpi" // This loads the RPi driver
)
...
Then install the EMBD package:
	...
	$ go get github.com/jjcinaz/embd
...
* This sample program is optimized for brevity and does not clean up after itself. Click here to
  see the [full version](https://github.com/jjcinaz/embd/blob/master/samples/fullblinker.go)
...
## The command line tool
	...
	go get github.com/jjcinaz/embd/embd
...
Although samples are all present in the [samples](https://github.com/jjcinaz/embd/tree/master/samples) folder,
we will show a few choice examples here.

Use the **LED** driver to toggle LEDs on the BBB:

```go
import "github.com/jjcinaz/embd"
import _ "github.com/jjcinaz/embd/host/all"
...
embd.InitLED()
defer embd.CloseLED()
...
...
```go
import "github.com/jjcinaz/embd"
import "github.com/jjcinaz/embd/sensor/bmp085"
import _ "github.com/jjcinaz/embd/host/all"
...
...
```go
import "github.com/jjcinaz/embd"
import "github.com/jjcinaz/embd/sensor/lsm303"
import _ "github.com/jjcinaz/embd/host/all"
...
bus := embd.NewI2CBus(1)
...
...
* **Digital GPIO** [Documentation](http://godoc.org/github.com/jjcinaz/embd#DigitalPin)
* **Analog GPIO** [Documentation](http://godoc.org/github.com/jjcinaz/embd#AnalogPin)
* **PWM** [Documentation](http://godoc.org/github.com/jjcinaz/embd#PWMPin)
* **I2C** [Documentation](http://godoc.org/github.com/jjcinaz/embd#I2CBus)
* **LED** [Documentation](http://godoc.org/github.com/jjcinaz/embd#LED)
* **SPI** [Documentation](http://godoc.org/github.com/jjcinaz/embd#SPIBus)

## Sensors Supported

* **TMP006** Thermopile sensor [Documentation](http://godoc.org/github.com/jjcinaz/embd/sensor/tmp006), [Datasheet](http://www.adafruit.com/datasheets/tmp006.pdf), [Userguide](http://www.adafruit.com/datasheets/tmp006ug.pdf)
* **BMP085** Barometric pressure sensor [Documentation](http://godoc.org/github.com/jjcinaz/embd/sensor/bmp085), [Datasheet](https://www.sparkfun.com/datasheets/Components/General/BST-BMP085-DS000-05.pdf)
* **BMP180** Barometric pressure sensor [Documentation](http://godoc.org/github.com/jjcinaz/embd/sensor/bmp180), [Datasheet](http://www.adafruit.com/datasheets/BST-BMP180-DS000-09.pdf)
* **LSM303** Accelerometer and magnetometer [Documentation](http://godoc.org/github.com/jjcinaz/embd/sensor/lsm303), [Datasheet](https://www.sparkfun.com/datasheets/Sensors/Magneto/LSM303%20Datasheet.pdf)
* **L3GD20** Gyroscope [Documentation](http://godoc.org/github.com/jjcinaz/embd/sensor/l3gd20), [Datasheet](http://www.adafruit.com/datasheets/L3GD20.pdf)
* **US020** Ultrasonic proximity sensor [Documentation](http://godoc.org/github.com/jjcinaz/embd/sensor/us020), [Product Page](http://www.digibay.in/sensor/object-detection-and-proximity?product_id=239)
* **BH1750FVI** Luminosity sensor [Documentation](http://godoc.org/github.com/jjcinaz/embd/sensor/bh1750fvi), [Datasheet](http://www.elechouse.com/elechouse/images/product/Digital%20light%20Sensor/bh1750fvi-e.pdf)
...
* **PCA9685** 16-channel, 12-bit PWM Controller with I2C protocol [Documentation](http://godoc.org/github.com/jjcinaz/embd/controller/pca9685), [Datasheet](http://www.adafruit.com/datasheets/PCA9685.pdf), [Product Page](http://www.adafruit.com/products/815)
* **MCP4725** 12-bit DAC [Documentation](http://godoc.org/github.com/jjcinaz/embd/controller/mcp4725), [Datasheet](http://www.adafruit.com/datasheets/mcp4725.pdf), [Product Page](http://www.adafruit.com/products/935)
* **ServoBlaster** RPi PWM/PCM based PWM controller [Documentation](http://godoc.org/github.com/jjcinaz/embd/controller/servoblaster), [Product Page](https://github.com/richardghirst/PiBits/tree/master/ServoBlaster)
...
[Pull requests](https://github.com/jjcinaz/embd/pulls) that follow the
[guidelines](https://github.com/jjcinaz/embd/blob/master/CONTRIBUTING.md) are very appreciated.
If you find a problem but are not up to coding a fix please file an
[issue](https://github.com/jjcinaz/embd/issues).
Thank you!

## About

EMBD is affectionately designed/developed by Karan Misra ([kidoman](https://github.com/kidoman)), Kunal Powar ([kunalpowar](https://github.com/kunalpowar)) and [FRIENDS](https://github.com/jjcinaz/embd/blob/master/AUTHORS). We also have a list of [CONTRIBUTORS](https://github.com/jjcinaz/embd/blob/master/CONTRIBUTORS).
